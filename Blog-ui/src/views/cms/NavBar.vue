  ...
  <el-header :style="'margin-bottom:' + headerBottom + 'px'">
    ...
    <div class="bg-purple-light el-menu-hidden" v-if="menuHiddenVisiable">
      <el-menu :default-active="activeIndex" router background-color="rgba(84,92,100,0.5)" text-color="#fff"
        ...
        <el-menu-item index="" href='https://oj.cloudcode.team/home'><a class="el-icon-star-off"
            style="color: rgba(255, 255, 255);" href='https://oj.cloudcode.team/home'
            target='_self'></a>OJ平台</el-menu-item>
    ...
    <div v-if="searchInput" class="search_input">
      <el-input @focus="checkInput" @blur="notSearching()" class="search" placeholder="搜索文章" prefix-icon="el-icon-search"
        v-model="queryInfo.query" size="mini">
      </el-input>
      <ul v-if="searching">
