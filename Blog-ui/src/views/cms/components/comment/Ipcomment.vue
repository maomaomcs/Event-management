<template>
  <el-container style="opacity: 0.9">
    <div class="author">
      ...
      <div>
        <div class="nkname">
          <span class="name" v-if="token==null">请登录后进行评论</span>
    ...
    <el-form :model="messageForm" :rules="messageFormRules" ref="messageFormRef">
      ...
      <el-form-item style="text-align: right">
        <el-button type="info" v-if="token==null">请登录</el-button>
        <el-button type="primary" @click="publish" v-else>发表评论</el-button>
      </el-form-item>
    </el-form>
