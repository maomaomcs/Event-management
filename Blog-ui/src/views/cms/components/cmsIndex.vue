  ...
  <el-row :gutter="20">
    ...
    <el-col :xs="24" :sm="5">
      ...
      <el-card style="background-color: rgba(255,255,255,0.9)" class=" right-item">
        ...
        <div class=" recommend-blog l-text" @click="gotoweboj">
          <a class="recommend-a">网工教学平台</a>
        </div>
        <div class=" recommend-blog l-text" @click="gotowebhome">
          <a class="recommend-a">云萌门户网站</a>
        </div>
        <div class=" recommend-blog l-text" @click="gotowebzym">
          <a class="recommend-a">爱摄影的攻城狮博客</a>
        </div>
        <div class=" recommend-blog l-text" @click="gotowebljx">
          <a class="recommend-a">Hoximi的博客</a>
        </div>
      </el-card>
    </el-col>
...
<script>
  ...
  export default {
    ...
    methods: {
      gotoweboj(){
        window.open('https://oj.cloudcode.team/home', '_blank')
      },
      gotowebhome(){
        window.open('https://home.cloudcode.team', '_blank')
      },
      gotowebzym(){
        window.open('https://www.yuque.com/cloudcodegeek', '_blank')
      },
      gotowebljx(){
        window.open('https://www.hoximi.cn/', '_blank')
      },
      /** 获取博客列表 */
      getBlogList() {
