<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="用户学号id" prop="userId">
        <el-input
          v-model="queryParams.userId"
          placeholder="请输入用户学号id"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="membersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="队伍成员表id" align="center" prop="id" />
      <el-table-column label="队伍id" align="center" prop="teamId" />
      <el-table-column label="用户学号id" align="center" prop="userId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="用户学号id" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入用户学号id" />
        </el-form-item>
        <el-form-item label="角色" prop="role">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        userId: [
          { required: true, message: "用户学号id不能为空", trigger: "blur" }
        ],
        role: [
