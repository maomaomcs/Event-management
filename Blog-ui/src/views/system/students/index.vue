<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="年级" prop="yearLevel">
        <el-input
          v-model="queryParams.yearLevel"
          placeholder="请输入年级"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="studentsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="年级" align="center" prop="yearLevel" />
...
:value="dict.value"
        ...
        <el-form-item label="年级" prop="yearLevel">
          <el-input v-model="form.yearLevel" placeholder="请输入年级" />
        </el-form-item>
        <el-form-item label="班级" prop="className">
