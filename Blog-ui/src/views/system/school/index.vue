...
import { listGRcompetitions1, addGRcompetitions1, updateGRcompetitions1 } from "@/api/system/GRcompetitions1";
  ...
  methods: {
    async fetchCompetitions() {
      try {
        ...
        const registeredResponse = await listGRcompetitions1();
    ...
    submitRegistration() {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          const action = this.form.id ? updateGRcompetitions1 : addGRcompetitions1;
          action({ ...this.form })
            .then(() => {
