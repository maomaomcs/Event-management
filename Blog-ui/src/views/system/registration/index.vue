<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="比赛地点" prop="competitionLocation">
        <el-input
          v-model="queryParams.competitionLocation"
          placeholder="请输入比赛地点"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="registrationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="比赛地点" align="center" prop="competitionLocation" />
      ...
      <el-table-column label="成员信息" align="center" prop="memberInfo" />
      <el-table-column label="当前状态" align="center" prop="paymentStatus" />
      <el-table-column label="报销状态" align="center" prop="reimbursementStatus" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="比赛地点" prop="competitionLocation">
          <el-input v-model="form.competitionLocation" placeholder="请输入比赛地点" />
        </el-form-item>
        <el-form-item label="报名时间" prop="registrationDate">
          <el-date-picker clearable size="small"
        ...
        <el-form-item label="成员信息" prop="memberInfo">
          <el-input v-model="form.memberInfo" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
